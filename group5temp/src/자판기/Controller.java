...
public class Controller extends Thread{
	...
	public static void ½ÃÀÛÄ«¿îÆ®() {
	 ...
	 public static boolean ·©Å©ÆÇÁ¤(long °ÔÀÓ½Ã°£) { // ·©Å©ÆÇÁ¤¸Þ¼Òµå
		 for(int i = 0 ; i < 5 ; i++) {
			 if(Drink.·©Å·.get(i).getPlaytime() < °ÔÀÓ½Ã°£) { // ·©Å© ¸®½ºÆ® 0~4ÀÎµ¦½º °ª°ú °ÔÀÓ½Ã°£ ºñ±³, 5À§¾È¿¡ µé¾úÀ» ½Ã true ¹ÝÈ¯
				 return true;
			 }
		 }
		 return false; // 0~4ÀÎµ¦½º °ª°ú ºñ±³ÇßÀ»¶§ °ÔÀÓ½Ã°£ÀÌ ÀÛÀ»¶§ false¹ÝÈ¯(5À§ ¾È¿¡ ¸øµé¾úÀ» ½Ã)
	 }
	 
	 public static void ·©Å©µî·Ï(long °ÔÀÓ½Ã°£, String ÀÌ¸§, String ÄÚ¸àÆ®) { // 5À§¾È¿¡ µé¾úÀ»½Ã ¸Å°³º¯¼ö ÀÌ¸§°ú ÄÚ¸àÆ®¸¦ ¹Þ¾Æ ·©Å© ¸®½ºÆ®¿¡ ÀúÀå
		 for(int i = 0 ; i < 5 ; i++) {
	 ...
	 public static void ·©Å©Ãâ·Â() { // ·©Å© Ãâ·Â ¸Þ¼Òµå
		 ...
		 for(int i = 0 ; i < 5 ; i++) {
			 System.out.println((i+1)+"\t"+ Drink.·©Å·.get(i).getName()+"\t"+ Drink.·©Å·.get(i).getPlaytime()+"\t\t"+ Drink.·©Å·.get(i).getContent());
		 }
		 System.out.println("---------------------");
	 }
